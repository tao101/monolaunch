...
export declare function configureNextjsForMonorepo(nextjsPath: string): void;
export declare function configureExpoForMonorepo(expoPath: string): void;
export declare function createRootTsConfig(projectPath: string): void;
